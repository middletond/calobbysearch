...
SELECT
  ...
  covers."THRU_DATE" AS end_date,
  payments."TRAN_ID" AS transaction_id,
  payments."EMPLR_NAMF" || ' ' || payments."EMPLR_NAML" AS employer_name,
  payments."EMPLR_NAML" AS employer_last_name,
  payments."EMPLR_NAMF" AS employer_first_name,
  payments."EMPLR_CITY" AS employer_city,
